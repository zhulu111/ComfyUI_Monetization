...
在您现有工作流的基础上，加入ComfyUI_Monetization插件，即可实现一键转换。
## 更新记录 
### 已更新
2024.7.3：  
1、增加储值功能；  
...
## 安装方式
1、通过ComfyUI-Manager在线安装，在ComfyUI-Manager中搜索“ComfyUI_Monetization”即可找到本插件（推荐）；  
...
## 使用示例和截屏说明
### SD变现宝示例工作流
点此下载[SD变现宝示例工作流](assets/SD变现宝示例工作流.json)。该工作流只为展现ComfyUI_Monetization插件的功能，比较简单，所以出图质量不好。但您可以把ComfyUI_Monetization插件放到您的任意工作流中，实现一键转换。
### ComfyUI插件端截屏
![Intro Image](assets/ComfyMon1.png) 
![Intro Image](assets/ComfyMon2.png) 
### 商家管理端截屏
